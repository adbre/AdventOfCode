...
namespace AdventOfCode
{
    ...
    public class Day5
    {
        ...
        [TestCase("ugknbfddgicrmopn\r\naaa\r\njchzalrnumimnmhp", ExpectedResult = 2)]
        [TestCase(PuzzleInput, ExpectedResult = 238, TestName = "Answer Part1")]
        public int Part1(string input)
        {
            return input.ReadLines(true).Count(line =>
            {
                if (line.Count(ch => "aeiou".Contains(ch)) < 3)
                    return false;

                if (!line.Any(ch => line.Contains(new string(ch, 2))))
                    return false;
        ...
        [TestCase("qjhvhtzxzqqjkmpb\r\nxxyxx\r\nuurcxstgmygtbstg", ExpectedResult = 2)]
        [TestCase(PuzzleInput, ExpectedResult = 69, TestName = "Answer Part2")]
        public int Part2(string input)
        {
            return input.ReadLines(true).Count(line =>
            {
                ...
                if (!ContainsPairOfAnyTwoLettersThatAppearsTwiceInTheStringWithoutOverlapping(line))
                    return false;
        ...
        [TestCase("xyxy", ExpectedResult = true)]
        [TestCase("cxyiiixy", ExpectedResult = true)]
        public bool ContainsPairOfAnyTwoLettersThatAppearsTwiceInTheStringWithoutOverlapping(string line)
        {
        ...
        [TestCase("xyxy", ExpectedResult = true)]
        [TestCase("efe", ExpectedResult = true)]
        [TestCase("abcdefeghi", ExpectedResult = true)]
        [TestCase("aaa", ExpectedResult = true)]
        public bool ContainsAtLeastOneLetterWhichRepeatsWithExactlyOneLetterBetweenThem(string line)
        {
        ...
        private const string PuzzleInput = @"zgsnvdmlfuplrubt
vlhagaovgqjmgvwq
ffumlmqwfcsyqpss
zztdcqzqddaazdjp
eavfzjajkjesnlsb
